  ...
  const updateWriters = (profile) => {
    ...
    for (let writer of writers) {
      if (writer.id === profile.id) {
        return updateNotification("warning", "Bu profil zaten seçili!");
      }
    }
        ...
        <div className="w-[70%] space-y-5">
          <div>
            ...
            <input
              ...
              placeholder="Örn: Succession"
            />
          </div>

          <div>
            <Label htmlFor="storyLine">Konu</Label>
            <textarea
              value={storyLine}
              onChange={handleChange}
              name="storyLine"
          ...
          <div>
            <div className="flex justify-between">
              <LabelWithBadge badge={cast.length}>Oyuncu Ekle</LabelWithBadge>
